...
g.add_node("世界渴望之城", ["提高建筑速度","提高单位生产力","提高工人人口上限","提高军事人口上限","+>【圣索菲亚大教堂】"], 10, [10, 20],former_nodes=["0026.工程技术","0020.农学","0022.矿井勘探"], node_type="ECO")

g.add_node("军事训练", ["X>【民兵】", "+>【刀剑手】", "+>【盾牌手】"], 20, [10, 20], node_type="MIL")
g.add_node("千夫队", ["提高步兵攻击力","提高步兵防御力","+>【兵营】"], 30, [10, 20], former_nodes=["军事训练"], node_type="MIL")
...
g.add_node("防御火力", ["提高远程单位攻击力","提高射击距离","+>【靶场】","+>【驻防点】"], 30, [10, 20], former_nodes=["陶罐希腊火"], node_type="MIL")
...
g.add_node("狄奥多西城墙", ["+>【石墙】"], 30, [10, 20], former_nodes=["军事训练"], node_type="MIL")
